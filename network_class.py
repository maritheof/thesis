...
class Network():
    ...
    def SGD(self, training_data, epochs, eta, mini_batch_size, test_data=False, dropout=False, trace_cost=False):
        #training_data is a list of tuples (x,y), where x and y are numpy 2D arraysf
        #validation_data in the same form as training_data
        ...
        for epoch, eta in zip(epochs, eta):
            for ep in range(epoch):                
                ...
                if dropout:
                    ...
                    #restoring the initial biases and weights array with the changes
